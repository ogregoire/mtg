...
final class AmountParsers {
    ...
    static Effect roundAmount(Effect e, Amount.Rounding rounding) {
        return switch (e) {
            ...
            case Effect.CreateToken(var creator, var count, var token, var tapped, var xDef) ->
                new Effect.CreateToken(creator, roundAmount(count, rounding), token, tapped, xDef);
            ...
            case Effect.EnterWithCounters(var subject, var count, var type, var additional, var xDef) ->
                new Effect.EnterWithCounters(subject, roundAmount(count, rounding), type, additional, xDef);
