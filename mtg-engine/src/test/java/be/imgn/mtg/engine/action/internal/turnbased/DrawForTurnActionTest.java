...
@DisplayName("DrawForTurnAction")
class DrawForTurnActionTest {

    private DrawForTurnAction action;
    private GameState gameState;
    private GameEventProcessor processor;

    @BeforeEach
    void setUp() {
        action = new DrawForTurnAction();
    ...
    class TimingTests {
        ...
        @Test
        void returnsDrawStepDraw() {
            assertThat(action.timing()).isEqualTo(TurnBasedTiming.DRAW_STEP_DRAW);
        }
    }
